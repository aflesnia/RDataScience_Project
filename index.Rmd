...
3.	Display the thickness for the first month of 2003 and the last month of 2008
4.  Download the Arctic boundary to further isolate the study area
5.	Create a linear regression displaying the month against the average sea ice thickness
6.	Visualize the difference via subtracting the 2003 thickness from the 2008 thickness, visualize the slope 
